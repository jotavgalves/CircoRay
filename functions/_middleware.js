...
export async function onRequest(context) {
  ...
  // Preserve API responses exactly as generated by the endpoint. This is
  // important for authentication because the login endpoint sets an
  // HttpOnly session cookie in the Set-Cookie response header.
