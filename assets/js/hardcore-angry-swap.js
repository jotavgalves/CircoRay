...
function isFury() {
  return document.body.classList.contains("cr-hardcore-fury") || Boolean(window.__circorayHardcoreFury);
}
...
export function initHardcoreAngrySwap() {
  ...
  style.textContent = `
    ...
    body.cr-hardcore-fury .clown-img.cr-hardcore-angry.cr-fury-clown{
      width:100%!important;
      height:var(--cr-clown-normal-height, auto)!important;
      object-fit:contain!important;
      object-position:center bottom!important;
      transform:none!important;
      filter:drop-shadow(0 0 16px #ff1d1d) drop-shadow(0 0 40px #b00000) drop-shadow(0 0 72px #5a0000)!important;
    }
    body.cr-hardcore-fury #cr-hardcore img.cr-fury-clown{
      object-fit:contain!important;
      object-position:center bottom!important;
      filter:drop-shadow(0 0 16px #ff1d1d) drop-shadow(0 0 38px #a00000) drop-shadow(0 0 64px #500000)!important;
    }
  `;
